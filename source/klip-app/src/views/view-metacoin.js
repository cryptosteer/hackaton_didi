...
class ViewMetacoin extends connect(CrcaStaticStore.store)(PageViewElement) {
  static get styles() {
    return [
      ...super.styles,
      css`
  ...
  render() {
    return html` <h1>MetaCoin — Example Truffle Dapp</h1>
      <p>
        You have
      ...
      <mwc-button raised @click=${this._sendCoin}> Send MetaCoin </mwc-button>
...
customElements.define('view-metacoin', ViewMetacoin);
